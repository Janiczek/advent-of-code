...
getCrashLocation : Cart -> Maybe Crash
...
crashToString : Crash -> String
crashToString ( x, y ) =
    String.fromInt x ++ "," ++ String.fromInt y


findCrash : ( Tracks, Carts ) -> Crash
findCrash ( _, carts ) =
    carts
    ...
    case stopBehaviour of
        ...
        StopAtLastAlive ->
            if hasMoreThanOneAlive carts then
                ...
                -- off-by-one error: it seems we have to do one more step after the last crash.
                step stopBehaviour ( tracks, carts )
